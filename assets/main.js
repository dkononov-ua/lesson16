...
let getLocalDate = (date, isSeconds = false, isISO = false) => {
  ...
  if (!isISO) {
    res = isSeconds
      ...
      : date.toLocaleDateString().replace(reg, "");
  } else {
...
console.log(getLocalDate(new Date(123456), true) === "01.01.1970, 03:02:03");
console.log(
  getLocalDate(new Date(123456), false, true) === "1970-01-01, 03:02"
);
console.log(
  getLocalDate(new Date(123456), true, true) === "1970-01-01, 03:02:03"
);
console.log(getLocalDate(new Date(1999999123456)) === "18.05.2033, 06:18");
console.log(
  getLocalDate(new Date(1999999123456), true) === "18.05.2033, 06:18:43"
);
console.log(
  getLocalDate(new Date(1999999123456), false, true) === "2033-05-18, 06:18"
);
console.log(
  getLocalDate(new Date(1999999123456), true, true) === "2033-05-18, 06:18:43"
);
